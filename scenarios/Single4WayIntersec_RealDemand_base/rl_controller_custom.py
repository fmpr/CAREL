...
class RLControllerCustom(RLController):
	...
	def determine_reward(self, junct_id):
		...
		if self.CONTROL_TYPE == self.PHASE_SELECTION:
			...
			window = range(-self.env.stats_count[junct_id],0)
		else:
			raise Exception("Unknown CONTROL_TYPE: "+str(self.CONTROL_TYPE))

		ttt = np.mean(list(self.env.total_travel_time)[-24:])
		n_waiting = np.mean(list(self.env.veh_waiting)[-24:])
		n_veh = np.mean(list(self.env.veh_count)[-24:])
		avg_tt = ttt / n_veh
		rolling_loss = (ttt + n_waiting*avg_tt) / (n_veh + n_waiting)

		# new version
		if junct_id == 913:
			q_lenths = [max(np.mean(np.array(self.env.tl_queue_lenghts[913][861][0])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][865][0])[window])),
						max(np.mean(np.array(self.env.tl_queue_lenghts[913][861][1])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][865][1])[window]), 
							np.mean(np.array(self.env.tl_queue_lenghts[913][861][2])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][865][2])[window]), 
							np.mean(np.array(self.env.tl_queue_lenghts[913][861][3])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][865][3])[window])),
						max(np.mean(np.array(self.env.tl_queue_lenghts[913][863][0])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][867][0])[window])),
						max(np.mean(np.array(self.env.tl_queue_lenghts[913][863][1])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][867][1])[window]),
							np.mean(np.array(self.env.tl_queue_lenghts[913][863][2])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][867][2])[window]),
							np.mean(np.array(self.env.tl_queue_lenghts[913][863][3])[window]), np.mean(np.array(self.env.tl_queue_lenghts[913][867][3])[window]))
						]
			total_queue_len = np.sum(np.array(q_lenths)**2)
		elif junct_id == 1047:
			q_lenths = [max(np.mean(np.array(self.env.tl_queue_lenghts[1047][866][0])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1037][0])[window])),
						max(np.mean(np.array(self.env.tl_queue_lenghts[1047][866][1])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1037][1])[window]),
							np.mean(np.array(self.env.tl_queue_lenghts[1047][866][2])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1037][2])[window]),
							np.mean(np.array(self.env.tl_queue_lenghts[1047][866][3])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1037][3])[window])),
						max(np.mean(np.array(self.env.tl_queue_lenghts[1047][1032][0])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1034][0])[window])),
						max(np.mean(np.array(self.env.tl_queue_lenghts[1047][1032][1])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1034][1])[window]),
							np.mean(np.array(self.env.tl_queue_lenghts[1047][1032][2])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1034][2])[window]),
							np.mean(np.array(self.env.tl_queue_lenghts[1047][1032][3])[window]), np.mean(np.array(self.env.tl_queue_lenghts[1047][1034][3])[window]))
						]
			total_queue_len = np.sum(np.array(q_lenths)**2)
		else:
			raise Exception("Invalid junct_id in rewards calculation")

		loss = total_queue_len + np.mean(np.array(self.env.veh_waiting)[-1])
		...
		reward = -1*(loss - self.env.last_losses[junct_id]) #-self.veh_waiting[-1]
		self.env.last_losses[junct_id] = loss
