...
SCENARIO_PATH = CODE_PATH+'/scenarios/Single4WayIntersec_RealDemand_incident_real'
...
def AAPIInit():
	log("Adding incidents...")
	res = AKIGenerateIncident(865, 3, 80, 50, 60*60, 2*60*60, 200, True, True, 200, 200, 30)
	log("Result:", res)
	res = AKIGenerateIncident(865, 4, 80, 50, 60*60, 2*60*60, 200, False, True, 200, 200, 30)
	log("Result:", res)
	return 0
